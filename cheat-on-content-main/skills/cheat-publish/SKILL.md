...
argument-hint: <prediction-file-or-url> [— platform: youtube|bilibili|douyin|fanqie|...]
...
| `fanqienovel.com/*` `fanqie.com/*` | fanqie |
...
- 番茄小说：从 URL 路径提取 `work_id`（fanqienovel.com/page/<work_id>）
- B 站：BV 号
- 小红书：note_id
