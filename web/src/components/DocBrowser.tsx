      ...
      <div className="grid gap-6 lg:grid-cols-[320px_minmax(0,1fr)]">
        <aside className="rounded-lg border border-gray-200 bg-white shadow-sm">
          ...
          {list.data && list.data.length === 0 && (
            <div className="px-4 py-6 text-sm text-gray-500">目录为空</div>
          )}
        ...
        <section className="rounded-lg border border-gray-200 bg-white shadow-sm">
          {!active && (
            <div className="flex h-full min-h-[400px] flex-col items-center justify-center px-6 py-16 text-center">
              ...
              <p className="mt-4 text-sm text-gray-500">从左侧选择一篇打开</p>
            </div>
          )}
            ...
            <article className="px-6 py-6 lg:px-8 lg:py-8">
              <div className="mb-4 flex items-center justify-between">
                <button
                  ...
                  className="inline-flex items-center text-sm text-gray-500 hover:text-gray-700 lg:hidden"
                >
